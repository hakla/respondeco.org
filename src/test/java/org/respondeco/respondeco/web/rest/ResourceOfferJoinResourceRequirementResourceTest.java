 ...
 *
 * @see ResourceOfferJoinResourceRequirementResource
 */
...
public class ResourceOfferJoinResourceRequirementResourceTest {
   ...
   private static final String DEFAULT_LAST_MODIFIED_DATE_STR = dateTimeFormatter.print(DEFAULT_LAST_MODIFIED_DATE);
    ...
    public void setup() {
        ...
        ResourceOfferJoinResourceRequirementResource resourceOfferJoinResourceRequirementResource = new ResourceOfferJoinResourceRequirementResource();

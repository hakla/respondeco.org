OrganizationControllerEdit = ($scope, $location, $routeParams, Organization, Account, User, OrgJoinRequest, TextMessage, AuthenticationSharedService, $rootScope) ->
  id = $routeParams.id
  isNew = id == 'new'
  organization = {}
  $scope.logo = null
...
angular
  ...
  .controller 'OrganizationControllerEdit', OrganizationControllerEdit

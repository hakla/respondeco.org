...
INSERT INTO `T_ISO_CATEGORY` (`KEY`) VALUES ('isocategory.gebuehrende_sorgfalt');
...
INSERT INTO `T_ISO_CATEGORY` (`KEY`) VALUES ('isocategory.menschenrechte_in_kritischen_situationen');
UPDATE `T_ISO_CATEGORY` SET `SUPER_CATEGORY_ID` = (SELECT id FROM `T_ISO_CATEGORY` WHERE `KEY` = 'isocategory.menschenrechte') WHERE `ID` = LAST_INSERT_ID();

INSERT INTO `T_ISO_CATEGORY` (`KEY`) VALUES ('isocategory.mittaeterschaft_vermeiden');
UPDATE `T_ISO_CATEGORY` SET `SUPER_CATEGORY_ID` = (SELECT id FROM `T_ISO_CATEGORY` WHERE `KEY` = 'isocategory.menschenrechte') WHERE `ID` = LAST_INSERT_ID();

INSERT INTO `T_ISO_CATEGORY` (`KEY`) VALUES ('isocategory.missstaende_beseitigen');
UPDATE `T_ISO_CATEGORY` SET `SUPER_CATEGORY_ID` = (SELECT id FROM `T_ISO_CATEGORY` WHERE `KEY` = 'isocategory.menschenrechte') WHERE `ID` = LAST_INSERT_ID();

INSERT INTO `T_ISO_CATEGORY` (`KEY`) VALUES ('isocategory.diskriminierung_und_schutzbeduerftige_gruppen');
UPDATE `T_ISO_CATEGORY` SET `SUPER_CATEGORY_ID` = (SELECT id FROM `T_ISO_CATEGORY` WHERE `KEY` = 'isocategory.menschenrechte') WHERE `ID` = LAST_INSERT_ID();

INSERT INTO `T_ISO_CATEGORY` (`KEY`) VALUES ('isocategory.buergerliche_und_politische_rechte');
UPDATE `T_ISO_CATEGORY` SET `SUPER_CATEGORY_ID` = (SELECT id FROM `T_ISO_CATEGORY` WHERE `KEY` = 'isocategory.menschenrechte') WHERE `ID` = LAST_INSERT_ID();

INSERT INTO `T_ISO_CATEGORY` (`KEY`) VALUES ('isocategory.wirtschaftliche_soziale_und_kulturelle_rechte');
UPDATE `T_ISO_CATEGORY` SET `SUPER_CATEGORY_ID` = (SELECT id FROM `T_ISO_CATEGORY` WHERE `KEY` = 'isocategory.menschenrechte') WHERE `ID` = LAST_INSERT_ID();

INSERT INTO `T_ISO_CATEGORY` (`KEY`) VALUES ('isocategory.grundlegende_prinzipien_und_rechte');
UPDATE `T_ISO_CATEGORY` SET `SUPER_CATEGORY_ID` = (SELECT id FROM `T_ISO_CATEGORY` WHERE `KEY` = 'isocategory.menschenrechte') WHERE `ID` = LAST_INSERT_ID();


INSERT INTO `T_ISO_CATEGORY` (`KEY`) VALUES('isocategory.konsumentenanliegen');

...
@Configuration
@EnableJpaRepositories("org.respondeco.respondeco.repository")
...
public class DatabaseConfiguration implements EnvironmentAware {
    ...
    @ConditionalOnMissingClass(name = "org.respondeco.respondeco.config.HerokuDatabaseConfiguration.class")
    ...
    public List<String> getBasePackages() {
        ...
        basePackages.add("org.respondeco.respondeco.domain");
        return basePackages;
    }

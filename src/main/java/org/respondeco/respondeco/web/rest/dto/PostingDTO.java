...
public class PostingDTO {
    ...
    public static PostingDTO fromEntity(Posting posting, List<String> fieldNames) {
        ...
        if (fieldNames.contains("author")) {
            responseDTO.setAuthor(UserDTO.fromEntity(posting.getAuthor(),Arrays.asList("id","login","organization","profilePicture")));
        }
    ...
    public PostingDTO(Long id, String information, User author, PostingFeed postingFeed, Date createdDate) {
        ...
        this.author = UserDTO.fromEntity(author,Arrays.asList("id","login","organization", "profilePicture"));
    ...
    public PostingDTO(Posting posting) {
        ...
        this.author = UserDTO.fromEntity(posting.getAuthor(),Arrays.asList("id","login","organization", "profilePicture"));

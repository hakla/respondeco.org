        ...
        <div class="row">
          <div class="col-lg-3 col-md-6 g-mb-40 g-mb-0--lg">
            <a class="d-block g-mb-20" href="index.html">
              <img class="img-fluid" src="/assets/images/logo-small.png" alt="Logo">
            </a>
            <p>respondeco.org ist der erste Online-Marktplatz für nachhaltige Unternehmen und soziale Organisationen.</p>
          </div>

          <div class="offset-lg-3 col-lg-3 col-md-6 g-mb-40 g-mb-0--lg">
      ...
      <!--<div class="container">-->
        <!--<div class="row">-->
          ...
          <!--<div class="col-md-3 md-margin-bottom-40">-->
            <!--<a href="index.html"><img id="logo-footer" class="footer-logo" src="/assets/images/logo-small.png" alt=""></a>-->
          <!--</div>-->
